...
export default function EditSurvey() {
  ...
  const addQuestion = () => {
    setQuestions([
      ...questions,
      { id: crypto.randomUUID(), type: 'single_choice', title: '', required: false, options: ['Option 1'] },
    ]);
  };
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
                ...
                <div className="space-y-2">
                  ...
                  {q.options?.map((opt: string, oi: number) => (
                    <div key={oi} className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() =>
                          updateQuestion(idx, { options: q.options.filter((_: any, i: number) => i !== oi) })
                        }
      ...
      <div className="flex justify-end gap-3">
        <Button variant="ghost" onClick={() => navigate(`/surveys/${id}`)}>
          Cancel
        </Button>
